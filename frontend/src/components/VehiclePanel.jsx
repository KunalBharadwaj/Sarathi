        ...
        <div>
            ...
            <div onClick={() => {
                ...
                <div className='ml-2 w-1/2'>
                    <h4 className='font-medium text-base'>SarathiGo <span><i className="ri-user-3-fill"></i>4</span></h4>
            ...
            <div onClick={() => {
                ...
                <div className='ml-2 w-1/2'>
                    <h4 className='font-medium text-base'>SarathiAuto <span><i className="ri-user-3-fill"></i>3</span></h4>
                    <h5 className='font-medium text-sm'>3 mins away </h5>
